...
import 'package:tawba/widgets/location_error_widget.dart';

class QiblahPage extends StatefulWidget {
  const QiblahPage({super.key});

  @override
  QiblahPageState createState() => QiblahPageState();
}
...
class QiblahPageWidget extends StatelessWidget {
  final _compassSvg = SvgPicture.asset(Assets.compass);
